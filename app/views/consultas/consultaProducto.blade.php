...
<div class="panel-heading">
	...
	<div class="row">
	    ...
	    <div class="form-group col-md-1">
	      {{ Form::text('idProducto', null, array( 'class' => 'form-control', 'id' => "idProducto ")) }}
	    </div>
      <div class="form-group col-md-2">
        {{ Form::text('search', null, array( 'class' => 'form-control', 'placeholder' => 'Nombre de producto', 'data-url' => 'producto', 'data-cod' => 'idProducto', 'id' => 'seadrch')) }}
